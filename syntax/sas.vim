...
syn match sasSectLblBlank /^\s*/ contained
syn region sasSectLbl start='/\*\*\s*' end='\s*\*\*/' contains=sasSectLblBlank
syn region sasSectLbl start='/\*-\s*' end='\s*-\*/'  contains=sasSectLblBlank
syn region sasSectLbl start='\v%(^|;)\s*\zs\%=\*\*\s*' end=';' contains=sasSectLblBlank
" Macros
...
hi def link sasSectLblBlank Normal
